...
static tWORD  *s_eroot  = NULL;
static tWORD  *s_groot  = NULL;
...
/*> char                                                                              <* 
 *> BTREE__swap_english     (tWORD *a_one, tWORD *a_two)                              <* 
 *> {                                                                                 <* 
 *>    /+---(locals)-----------+-----------+-+/                                       <* 
 *>    char        rce         =  -10;                                                <* 
 *>    /+---(beginning)----------------------+/                                       <* 
...
/*> char                                                                              <* 
 *> BTREE__swap_gregg       (tWORD *a_one, tWORD *a_two)                              <* 
 *> {                                                                                 <* 
 *>    /+---(locals)-----------+-----------+-+/                                       <* 
 *>    char        rce         =  -10;                                                <* 
 *>    /+---(beginning)----------------------+/                                       <* 
 ...
 *>    int         x_match     =    0;                                                                                                                                                                                                                                   <* 
 *>    char        x_flag      =  '-';                                                                                                                                                                                                                                   <* 
 *>    tWORD     *x_head      = NULL;          /+ current position               +/                                                                                                                                                                                      <* 
 *>    tWORD     *x_base      = NULL;          /+ current position               +/                                                                                                                                                                                      <* 
 *>    tWORD     *x_tele      = NULL;          /+ teleport point                 +/                                                                                                                                                                                      <* 
 *>    tWORD     *x_comp      = NULL;          /+ comparison item                +/                                                                                                                                                                                      <* 
 *>    char        x_swap      =  '-';                                                                                                                                                                                                                                   <* 
 *>    /+---(header)-------------------------+/                                                                                                                                                                                                                          <* 
 *>    DEBUG_SORT   yLOG_enter   (__FUNCTION__);                                                                                                                                                                                                                         <* 
 *>    /+---(check list)---------------------+/                                                                                                                                                                                                                          <* 
...
/*> tWORD*                                                                                                                     <* 
 *> BTREE__nextlevel   (char a_type, int a_lvl, int a_pos, int a_dist, char a_dir, tWORD *a_word)                              <* 
 *> {                                                                                                                          <* 
 *>    /+---(locals)-----------+-----+-----+-+/                                                                                <* 
 *>    tWORD     *x_word      = NULL;                                                                                          <* 
 *>    int         x_pos       =    0;                                                                                         <* 
...
/*> char                                                                                          <* 
 *> BTREE__display        (char a_type, int a_lvl, tWORD *a_word)                                 <* 
 *> {                                                                                             <* 
 *>    char        x_pre       [LEN_RECD] = "";                                                   <* 
 *>    int         i           =    0;                                                            <* 
...
/*> char                                                                                                                       <* 
 *> BTREE__searchdown       (char a_type, tWORD **a_found, tWORD *a_word, char *a_dir, llong a_key)                            <* 
 *> {                                                                                                                          <* 
 *>    /+---(locals)-----------+-----+-----+-+/                                                                                <* 
 *>    int         rc          =    0;                                                                                         <* 
 *>    llong       x_key       =    0;                                                                                         <* 
...
/*> char                                                                                        <* 
 *> BTREE__start            (char a_type, tWORD **a_found, char *a_word)                        <* 
 *> {                                                                                           <* 
 *>    /+---(locals)-----------+-----+-----+-+/                                                 <* 
 *>    char        rce         =  -10;                                                          <* 
 *>    char        rc          =    0;                                                          <* 
...
/*> char BTREE_by_english  (tWORD **a_found, char *a_word) { return BTREE__start ('e', a_found, a_word); }   <*/
/*> char BTREE_by_gregg    (tWORD **a_found, char *a_word) { return BTREE__start ('g', a_found, a_word); }   <*/
