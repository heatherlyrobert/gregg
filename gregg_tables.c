...
tGROUPS     g_groups [MAX_GROUPS] = {
   ...
   /*> {      4,     2, "4------", "-1------",  "zx",   10,  USE  },                  <*/
   /*---( f family)--------*//*--------------------------------------*/
   {      4,     1, "4------", "--2345--", CAT_F  ,  USE  },
   {      4,     2, "43-----", "--2345--", CAT_F  ,  USE  },
   /*---( p family)--------*//*--------------------------------------*/
   {      4,     1, "4------", "--2345--", CAT_P  ,  USE  },
   ...
   {      5,     1, "3------", "0-------", CAT_CH ,  USE  },
   /*---( f family)--------*//*--------------------------------------*/
   {      5,     1, "3------", "--2345--", CAT_F  ,  USE  },
   {      5,     2, "43-----", "--2345--", CAT_F  ,  USE  },
   /*---( p family)--------*//*--------------------------------------*/
   {      5,     1, "3------", "--2345--", CAT_P  ,  USE  },
...
tLOCATION   g_loc [MAX_LETTERS] = {
   ...
   { "ts" ,  SHAPE_ELLIPSE ,   8,   4,  50, 140,-230, CAT_DF  ,   2,   1,  127,  -40, YF_BOTRIG, 0, 0, 0, 0, 0, 0, 0, 0 },
   { "df" ,  SHAPE_ELLIPSE ,  14,   7,  50, 140,-230, CAT_DF  ,   2,   2,  115,  -40, YF_BOTRIG, 0, 0, 0, 0, 0, 0, 0, 0 },
   ...
   { "s"  ,  SHAPE_ELLIPSE ,   4,   3,  55,  20, 165, CAT_P   ,   4,   1,   65, -138, YF_BOTRIG, 0, 0, 0, 0, 0, 0, 0, 0 },
   ...
   /*-comb,  ---shape----- , -sx, -sy, rot, beg, arc, -cat--- , -ra, -szo --tx, --ty, -align-- ,-----,-----clcuate----- */
   { "pt" ,  SHAPE_ELLIPSE ,   8,   4,  50,  90, 230, CAT_PT  ,   2,   1,  132, -125, YF_BOTRIG, 0, 0, 0, 0, 0, 0, 0, 0 },
   { "bd" ,  SHAPE_ELLIPSE ,  14,   7,  50,  90, 230, CAT_PT  ,   2,   2,  120, -125, YF_BOTRIG, 0, 0, 0, 0, 0, 0, 0, 0 },
   ...
   { "o"  ,  SHAPE_ELLIPSE ,   5,   5,   0, 190, 160, CAT_O   ,   9,   1,   59,  -82, YF_BOTRIG, 0, 0, 0, 0, 0, 0, 0, 0 },
   { "u"  ,  SHAPE_ELLIPSE ,   5,   5,   0, 170,-160, CAT_U   ,   2,   2,   90,  -59, YF_TOPRIG, 0, 0, 0, 0, 0, 0, 0, 0 },
